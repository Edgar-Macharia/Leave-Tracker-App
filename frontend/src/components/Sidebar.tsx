...
import lta from '../images/logo/lta-logo.png'
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-1">
        <NavLink to="/dashboard">
          <span className='flex items-center'>
            <img className='h-28' src={lta} alt="Logo" />
          </span>
        </NavLink>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="px-4 lg:mt-5 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {currentUser?.roles.includes('ADMIN', 'LINE_MANAGER') &&
                <SidebarLinkGroup
                  activeCondition={
              ...
              <li>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 2048 2048">
                    <path fill="white" d="m2011 960l-446 445l-90-90l291-291H768V896h998l-291-291l90-90l446 445zm-859 320h128v640H0V0h1280v640h-128V128H128v1664h1024v-512z" />
                  </svg>
                  Request Leave
                </NavLink>
              </li>
